...
bool
custom_interface__msg__Distvel__are_equal(const custom_interface__msg__Distvel * lhs, const custom_interface__msg__Distvel * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
custom_interface__msg__Distvel__copy(
  const custom_interface__msg__Distvel * input,
  custom_interface__msg__Distvel * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
custom_interface__msg__Distvel__Sequence__are_equal(const custom_interface__msg__Distvel__Sequence * lhs, const custom_interface__msg__Distvel__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_interface__msg__Distvel__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
custom_interface__msg__Distvel__Sequence__copy(
  const custom_interface__msg__Distvel__Sequence * input,
  custom_interface__msg__Distvel__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_interface__msg__Distvel);
    custom_interface__msg__Distvel * data =
      (custom_interface__msg__Distvel *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_interface__msg__Distvel__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          custom_interface__msg__Distvel__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_interface__msg__Distvel__copy(
